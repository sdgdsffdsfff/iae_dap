	...
	switch(idx){
		case 0:{
			...
			if(bd==null||bd==""||ed==null||ed==""){
				...
				var url = basePath+'cntv/getSearchDataByDay.json?user_name='+user+'&type=2&bgDate='+bd+'&endDate='+ed+'&bgHour='+bh+'&endHour='+eh+'&searchSource=ShoushiDay';
				loadDataSSD(url);
			}
			break;
		}
		case 1:{
			...
			if(bt==null||bt==""||et==null||et==""){
				...
				$("#chart_box_"+id).html('<div class="dengdai"><img src="style/img/loadingNew.gif"/></div>');
				var url = basePath+'cntv/getSearchDataInfo.json?user_name='+user+'&type=2&bgDate='+bt+'&endDate='+et+'&chnnlName='+pro+'&searchSource=ShoushiTime';
				loadDataSST(url);
			}
			break;
		}
		case 2:{
			...
			if(bd1==null||bd1==""||ed1==null||ed1==""){
				...
				$("#chart_box_"+id).html('<div class="dengdai"><img src="style/img/loadingNew.gif"/></div>');
				var url = basePath+'cntv/getSearchDataByArea.json?user_name='+user+'&type=2&bgDate='+bd1+'&endDate='+ed1+'&searchSource=ShoushiArea';
				loadDataSSA(url);
			}
			break;
		}
