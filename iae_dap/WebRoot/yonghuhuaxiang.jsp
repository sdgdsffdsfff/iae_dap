...
<body style="background:url('image/bg_sub1.jpg') 0 0 no-repeat transparent;">
	...
	<div class="contain">
		<div class="l_contain" id ="tab_change">
			<ul class="tab_change">
				<li class="cur"><a href="#">用户在线时长分类</a></li>
				<li><a href="#">用户质量分类</a></li>
			</ul>
		</div>
		<div class="r_contain">
			<div class="block" style="display:block">
				<div class="csmB_ind005">
					...
					<div class="zhezhao"><iframe id="dap_iframe" style="width:850px;height:480px;border:none;position:relative;right:24px;top:20px;" src="./shichangfenlei.jsp"></iframe></div>
			...
			<div class="block" style="display:none">
				<div class="csmB_ind006">
					...
					<div class="zhezhao"><iframe id="dap_iframe2" style="width:850px;height:480px;border:none;position:relative;right:24px;top:20px;" src="./zhiliangfenlei.jsp"></iframe></div>
